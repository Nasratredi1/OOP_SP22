package Test_for_protected;

import Lec_18_Inheritance.Student;

public class TestApp {
    public static void main(String[] args) {
       // Student std = new Student(1,"Ali","OOP");
        Lec_18_Inheritance.Student std = new Student(1,"Ahmad","OOP");

//        System.out.println(std.id);
//        System.out.println(std.name);
        System.out.println(std.getCourseName());
       // System.out.println(std.id);// we can't access in other objects.
